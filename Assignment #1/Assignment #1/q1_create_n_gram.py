...
def create_n_gram_wcount(documents, n=1):
    n_gram = dict()
    ...
    return n_gram, total_occurence_count
    
def create_n_gram(documents, n=1):
    n_gram, _ = create_n_gram_wcount(documents, n)
    return n_gram

if __name__ == '__main__':
    ds = ['Mother washed the 2nd frame', 'The frog jumped unsuccessfully', 'I won 2nd prize']

    print('1-grams:', create_n_gram(ds))

    print('5-grams:', create_n_gram(ds, n=2))
